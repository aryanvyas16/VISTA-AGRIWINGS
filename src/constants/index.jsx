export const features = [
  ...
  export const faq = [
    {
      id: "0",
      question: " What is a spray drone and how does it work?",
      answer:
        "A spray drone is an unmanned aerial vehicle used for spraying pesticides, fertilizers, or disinfectants. It uses GPS, sensors, and automated flight paths to ensure even and precise spraying over crops or large surfaces.",

    },
    {
      id: "1",
      question: "What kind of crops or areas can your drones be used for?",
      answer:
        "Our spray drones are suitable for a variety of crops like rice, wheat, cotton, sugarcane, and vegetables. They can also be used in orchards, greenhouses, and for sanitation in urban areas.",
    },
    {
      id: "2",
      question: "How much area can a drone cover in one flight?",
      answer:
        "Depending on the model and payload, our drones can cover between 6 to 15 acres per hour. Actual coverage may vary with terrain and spraying conditions.",
    },
    {
      id: "3",
      question: "What is the maximum payload capacity?",
      answer:
    ...
    },
    {
      ...
      answer:
        "Our drones are available in models with payload capacities ranging from 10 to 30 liters, giving flexibility based on your spraying needs.",
    },
    {
      id: "5",
      question: "Are the drones easy to operate for new users?",
      answer:
        "Yes. Our drones are designed to be beginner-friendly with automated takeoff, landing, and spraying. We also provide hands-on training and support for smooth onboarding.",
    },
    {
      id: "6",
      question: "Do I need any license or permission to fly these drones?",
      answer:
        "In most regions, yes. Drone registration and operator licenses may be required. We assist our customers in understanding and completing the necessary formalities.",
    },
    {
      id: "7",
      question: "What kind of maintenance is required?",
      answer:
        "Routine maintenance includes cleaning the drone, checking batteries, inspecting spray nozzles, and ensuring software is up to date. We offer support and maintenance guides.",
    },
    {
      id: "8",
      question: "How long does the battery last?",
      answer:
        "Each battery lasts around 15–25 minutes depending on payload and weather. Swappable batteries allow for continuous operation with minimal downtime.",
    },
    {
      id: "9",
      question: "Do you offer after-sales support and training?",
      answer:
        "Absolutely. We provide detailed training, user manuals, remote support, spare parts, and servicing to ensure your drone stays in top condition.",
    },
  ];
  ...
  export const plans = [
    {
      ...
      priceMonthly: 6999,
      priceYearly: 22999,
      caption: "Precision spraying on compact fields",
      features: [
    ...
    },
    {
      ...
      priceMonthly: 11999,
      priceYearly: 44999,
      caption: "Best for Large-Scale Farms",
      features: [
        "High-capacity tank",
        "Dual battery system",
    ...
    },
    {
      ...
      priceMonthly: 8999,
      priceYearly: 27999,
      caption: " Best for Versatile Agricultural Operations",
      features: [
        "AWider spray coverage",
